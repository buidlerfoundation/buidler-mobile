    ...
    const ImageElements = this.props.imageUrls.map((image, index) => {
      ...
      switch (imageInfo.status) {
        ...
        case 'success':
          ...
          const isVideo = ImageHelper.isVideo(image.props.source.uri);
          return (
            <ImageZoom
              key={index}
              ...
              onClick={this.handleClick}
              onDoubleClick={this.handleDoubleClick}
              imageWidth={isVideo ? screenWidth : width}
              imageHeight={isVideo ? screenHeight : height}
              enableSwipeDown={this.props.enableSwipeDown}
              swipeDownThreshold={this.props.swipeDownThreshold}
              onSwipeDown={this.handleSwipeDown}
              ...
              doubleClickInterval={this.props.doubleClickInterval}
              minScale={isVideo ? 1 : this.props.minScale}
              maxScale={isVideo ? 1 : this.props.maxScale}>
