...
import InstalledAppModule from 'common/InstalledAppModule';
...
export async function isAppInstalled(
  ...
  return await InstalledAppModule.isAppInstalled(
    Platform.OS === 'android' ? applicationId : appScheme,
  );
}
...
export const fetchAllWallets = () => {
  return fetch(
    `https://explorer-api.walletconnect.com/v3/wallets?projectId=${WC_PROJECT_ID}&sdks=sign_v2`,
  )
    .then(res => res.json())
    .then(
      wallet => {
