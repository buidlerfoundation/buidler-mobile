...
export const uploadToIPFS = (taskId: string, body: any) =>
  ApiCaller.post(`task/${taskId}/ipfs`, body);
...
export const getTasks = (
  ...
  return ApiCaller.get<Array<TaskData>>(uri, undefined, controller);
};
...
export const getArchivedTasks = (
  ...
  return ApiCaller.get<Array<TaskData>>(uri);
};
...
export const getPostById = (postId: string) =>
  ApiCaller.get<TaskData>(`task/${postId}`);
