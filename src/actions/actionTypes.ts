...
const DIRECT_CHANNEL_PREFIX = 'DIRECT_CHANNEL';
...
export const actionTypes = {
  ...
  SET_CURRENT_DIRECT_CHANNEL: 'SET_CURRENT_DIRECT_CHANNEL',
  ...
  GET_TEAM_DIRECT_USER: 'GET_TEAM_DIRECT_USER',
  TRANSACTION_PREFIX,
  ...
  SYNC_DIRECT_CHANNEL_DATA: 'SYNC_DIRECT_CHANNEL_DATA',
  UPDATE_TEAM_FROM_SOCKET: 'UPDATE_TEAM_FROM_SOCKET',
  TOGGLE_SOCKET_RECONNECT: 'TOGGLE_SOCKET_RECONNECT',
  DIRECT_CHANNEL_PREFIX,
  DIRECT_CHANNEL_REQUEST: DIRECT_CHANNEL_PREFIX + _REQUEST,
  DIRECT_CHANNEL_SUCCESS: DIRECT_CHANNEL_PREFIX + _SUCCESS,
  DIRECT_CHANNEL_FAIL: DIRECT_CHANNEL_PREFIX + _FAIL,
  SOCKET_CONNECTING: 'SOCKET_CONNECTING',
  UPDATE_WC_URI: 'UPDATE_WC_URI',
};
